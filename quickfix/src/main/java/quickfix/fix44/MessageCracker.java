...
public class MessageCracker {
    ...
    * @throws IncorrectTagValue
    */
    public void onMessage(ConfirmationAck message, SessionID sessionID)
        throws FieldNotFound, UnsupportedMessageType, IncorrectTagValue {
        throw new UnsupportedMessageType();
    }
    ...
    * @throws IncorrectTagValue
    */
    public void onMessage(NetworkStatusRequest message, SessionID sessionID)
        throws FieldNotFound, UnsupportedMessageType, IncorrectTagValue {
        throw new UnsupportedMessageType();
    }
    ...
    * @throws IncorrectTagValue
    */
    public void onMessage(NetworkStatusResponse message, SessionID sessionID)
        throws FieldNotFound, UnsupportedMessageType, IncorrectTagValue {
        throw new UnsupportedMessageType();
    }
    ...
    */
    ...
    public void crack44(Message message, SessionID sessionID)
        ...
        } else if (msgTypeValue.equals(ConfirmationAck.MSGTYPE)) {
        ...
        } else if (msgTypeValue.equals(NetworkStatusRequest.MSGTYPE)) {
            onMessage((NetworkStatusRequest) message, sessionID);
        } else if (msgTypeValue.equals(NetworkStatusResponse.MSGTYPE)) {
